            ...
            <div class="grid grid-cols-1 px-4 mb-16">
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div
                        ...
                        <h2 class="text-white font-normal text-2xl">Category</h2>
                        <a href="{{ route('category.create') }}" class="px-4 py-1 text-base font-normal text-white">Create
                            Category</a>
                    </div>
                            ...
                            <table class="items-center w-full bg-transparent border-collapse">
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            <th
                                            class="px-2 text-indigo-400 align-middle border-b border-solid border-gray-200 py-3 text-lg whitespace-nowrap font-medium text-left">
                                            Main_Featured Status</th>
                                            <th
                                            class="px-2 text-indigo-400 align-middle border-b border-solid border-gray-200 py-3 text-lg whitespace-nowrap font-medium text-left">
                                            Main_Featured Action</th>
                                            <th
                                            class="px-2 text-indigo-400 align-middle border-b border-solid border-gray-200 py-3 text-lg whitespace-nowrap font-medium text-left">
                                            Featured Status</th>
                                            <th
                                ...
                                <tbody>
                                    @foreach ($categories as $key => $item)
                                        <tr class="hover:bg-gray-100 transition duration-150 ease-in-out">
                                            ...
                                            <td
                                                ...
                                                <img src="{{ asset($item->image) }}" alt=""
                                                    class="object-contain h-12 object-left">
                                            </td>
                                        ...
                                        <td
                                        class="px-2 py-4 border-b border-gray-200 border-solid">

                                        @if ($item->main_featured)
                                        <button class="px-4 py-1 text-base text-green-700 font-medium rounded-sm
                                       ">Main Featured : True </button>
                                    @else
                                        <a href="javscript:void(0)" class="px-4 py-1 text-base whitespace-nowrap text-red-700 rounded-sm font-medium">
                                      <span class="text">Main Featured : False</span> </a>
                                    @endif</td>
                                    <td
                                    class="px-2 py-4 border-b border-gray-200 border-solid">
                                    @if ($item->main_featured)
                                    <a href="{{ route('category.removemain_featured' , $item->id ) }}" class="  px-4 py-1 text-base text-white bg-red-500 rounded-sm whitespace-nowrap shadow-md
                                        hover:bg-red-600 hover:shadow-lg
                                        transition
                                        duration-150
                                        ease-in-out">
                                      <span class="text">Remove Main_Featured</span> </a>
                                    @else
                                    <a href="{{ route('category.setmain_featured' , $item->id ) }}" class="  px-4 py-1 text-base text-white bg-green-600 rounded-sm whitespace-nowrap shadow-md
                                        hover:bg-green-700 hover:shadow-lg
                                        transition
                                        duration-150
                                        ease-in-out">

                                      <span class="text">Set Main_Featured</span> </a>
                                    @endif</td>
                                    ...
                                    class="px-2 py-4 border-b border-gray-200 border-solid">
                                    @if ($item->featured)
                                    <button class="px-4 py-1 text-base whitespace-nowrap  text-green-700 font-medium rounded-sm " >Featured : True </button>
                                @else
                                    <a href="javscript:void(0)" class="px-4 py-1 text-base whitespace-nowrap text-red-700 font-medium rounded-sm">
                                  <span class="text">Featured : False</span> </a>
                                @endif</td>

                                <td
                                class="px-2 py-4 border-b border-gray-200 border-solid">
                                @if ($item->featured)
                                <a href="{{ route('category.removefeatured' , $item->id ) }}" class="  px-4 py-1 text-base text-white bg-red-500 rounded-sm whitespace-nowrap shadow-md
                                    hover:bg-red-600 hover:shadow-lg
                                    transition
                                    duration-150
                                    ease-in-out">
                                ...
                                @else
                                <a href="{{ route('category.setfeatured' , $item->id ) }}" class="  px-4 py-1 text-base text-white bg-green-600 rounded-sm whitespace-nowrap shadow-md
                                    hover:bg-green-700 hover:shadow-lg
                                    transition
                                    duration-150
                                    ease-in-out">
