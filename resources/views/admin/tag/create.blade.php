            ...
            <div class="grid grid-cols-1 px-4 mb-16">
                <div class="w-8/12 mr-auto bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div
                        ...
                        <h2 class="text-white text-2xl">Tag</h2>
                        <a href="{{ route('tag.index') }}" class="px-4 py-1 text-base font-normal text-white">Back</a>
                    </div>
                                        ...
                                        <div class="block p-6 rounded-lg shadow-lg bg-white w-full">
                                            <form
                                                ...
                                                <div class="form-group mb-6">
                                                    ...
                                                    <input type="text" name="tagname" placeholder="Enter Tagname"
                                                        value="{{ isset($tag) ? $tag->tagname : old('tagname') }}"
